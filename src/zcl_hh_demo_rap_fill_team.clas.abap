CLASS zcl_hh_demo_rap_fill_team DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_hh_demo_rap_fill_team IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA team_members TYPE STANDARD TABLE OF zhh_dmo_team WITH EMPTY KEY.
    ...
    DELETE FROM zhh_dmo_team.
    INSERT zhh_dmo_team FROM TABLE @team_members.
    COMMIT WORK.
  ENDMETHOD.
ENDCLASS.
