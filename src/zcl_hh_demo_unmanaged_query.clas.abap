CLASS zcl_hh_demo_unmanaged_query DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PRIVATE SECTION.
    METHODS
      get_data_from_request
        ...
        RETURNING VALUE(rt_result) TYPE zif_hh_demo_rap_data_handler=>tt_data
        RAISING   cx_rap_query_filter_no_range.
ENDCLASS.


CLASS zcl_hh_demo_unmanaged_query IMPLEMENTATION.
  METHOD if_rap_query_provider~select.
    DATA lt_output TYPE TABLE OF ZHH_C_DMOUnmanaged.
  ...
  METHOD get_data_from_request.
    DATA lt_r_key  TYPE zif_hh_demo_rap_data_handler=>tt_r_key.
    DATA lt_r_text TYPE zif_hh_demo_rap_data_handler=>tt_r_text.
    DATA lt_r_date TYPE zif_hh_demo_rap_data_handler=>tt_r_date.
    ...
    rt_result = zcl_hh_demo_rap_data_handler=>create_instance( )->query( it_r_key  = lt_r_key
                                                                         it_r_text = lt_r_text
                                                                         it_r_date = lt_r_date ).
  ENDMETHOD.
ENDCLASS.
