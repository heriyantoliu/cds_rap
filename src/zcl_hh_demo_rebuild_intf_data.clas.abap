CLASS zcl_hh_demo_rebuild_intf_data DEFINITION PUBLIC FINAL CREATE PUBLIC.
  PUBLIC SECTION.
...
CLASS zcl_hh_demo_rebuild_intf_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    zcl_hh_demo_rebuild_intf_data=>rebuild_data( ).
  ENDMETHOD.

  METHOD rebuild_data.
    DATA lt_names TYPE SORTED TABLE OF zhh_dmo_cname WITH UNIQUE KEY name.
    ...
    INSERT zhh_dmo_cname FROM TABLE @lt_names.
    COMMIT WORK.
  ENDMETHOD.
ENDCLASS.
